...
# Kernel
export FLAGS="$("$root_dir/tools/shell/escape.sh" "-Wl,-T$script_dir/kernel/kernel.ld") -mno-red-zone -mno-mmx -mno-sse -mno-sse2"
...
export FLAGS="" FLAGS_X86_64="$("$root_dir/tools/shell/escape.sh" "-I$out_base_dir/kernel/x86_64")"
