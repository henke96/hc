static void _x25519_test(int32_t iterations, const uint8_t *k, const uint8_t *u, const uint8_t *expected) {
    uint8_t out[32];
    uint8_t nextK[32];
    uint8_t nextU[32];
...
static void _x25519_testEcdh(void) {
...
static void x25519_tests(uint64_t level) {
