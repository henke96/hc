...
if "%ARCH%" == "wasm32" (
    ...
    if "%ABI%" == "windows-gnu" (
        ...
        set "extra_flags=-fno-plt -Wl,-dynamic-linker=,--build-id=none,--hash-style=gnu,-znognustack,-znorelro,-znow"
    )
)
